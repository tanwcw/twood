...
public class GetBalance{
    ...
    public static String getBalance(String vault_id) throws InterruptedException, ExecutionException {

        postSender ps = new postSender(vault_id);
...
//            connection.setRequestProperty("Content-Type", "application/json");
    ...
    private static class postSender extends AsyncTask<String, Void, String> {
        ...
        public postSender(String vault_id) {
            super();
        ...
        protected String doInBackground(String[] params) {
            ...
            final String apiURL = "https://hack.modoapi.com/1.0.0-dev/vault/get_balance";
            ...
            try {
                ...
                outputsArray.put(vault_id);
                request.put("item_ids", outputsArray);
